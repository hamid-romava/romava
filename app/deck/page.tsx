...
const sections: SectionType[] = [
  ...
  },
  {
    id: 3,
    type: "solution",
    title: "خلق با ۱۱۷ تکنیک داستان سرایی متناسب با هویت برند",
    desc: " با انجام تحقیقات بازار و کشف بازاری ، استراتژی محتوات رو مشخص می‌کنیم و از بین ۱۱۷ تکنیک داستان سرایی بهترین مدل محتوا رو برای برندت مشخص می‌کنیم ",
    image: "/team.jpg",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    desc: "در هر مرحله هدف محتوا رو مشخص خواهیم کرد و صرفا به ازای نتیجه هزینه دریافت می‌کنیم بعلاوه هزینه پس پرداخت خواهد بود یعنی بعد از رسیدن به نتیجه و قبل از محتوای بعدی هزینه رو پرداخت می‌کنی",
    image: "/start.jpg",
  },
];
      ...
      >
        ...
        >
          ...
          <p className="text-lg md:text-xl text-white/70 leading-9">
            ...
            ما یه تیم استارتاپی با پیش زمینه‌ی بهبود فروش با بهبود سایت و اپلیکیشن هستیم 
             که به تازگی تصمیم به ورود به حوزه تولید محتوا گرفتیم
          </p>
        </motion.div>
      </section>
